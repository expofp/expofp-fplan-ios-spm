...
#ifndef EXPOFPFPLAN_SWIFT_H
#define EXPOFPFPLAN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ExpoFpFplan",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC11ExpoFpFplan11UIFplanView")
@interface UIFplanView : UIView
...
@interface UIFplanView (SWIFT_EXTENSION(ExpoFpFplan)) <WKNavigationDelegate>
...
@class WKFrameInfo;
@interface UIFplanView (SWIFT_EXTENSION(ExpoFpFplan)) <WKUIDelegate>
